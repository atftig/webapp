...
<div class="container mt-5">
    ...
    <form action="{{ route('store-pv') }}" method="POST">
        ...
        <label for="insegna" class="form-label" style="font-size: 1.8rem;">Scegli Insegna</label>
            <select class="form-select" id="select-insegna" name="insegna" required
            ...
            <input type="text" class="form-control mt-2" id="input-insegna" name="insegna" placeholder="Inserisci insegna"
